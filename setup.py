...
setup(
    ...
    version=get_version(),
    description="Generate a Django model, views, URLconf, " "and templates on the command line in seconds.",
    long_description="Please see the Github page for details: " "http://github.com/modocache/django-generate-scaffold",
    keywords="django generate scaffold",
    author="modocache",
    author_email="modocache@gmail.com",
    url="http://github.com/modocache/django-generate-scaffold",
    install_requires=["Django>=4.1.7", "python_version >= 3.11"],
    packages=[
        "generate_scaffold",
